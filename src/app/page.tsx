			...
			<MaxWidthWrapper>
				<div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
					...
					<p className="mt-6 text-lg max-w-prose text-muted-foreground">
						Welcome to Digital Hippo Lorem ipsum dolor sit amet consectetur
						adipisicing elit. Consequuntur eligendi officia laudantium sequi
						quibusdam. Assumenda suscipit qui ducimus aspernatur, vel laudantium
						incidunt beatae voluptatum molestias sapiente! Ea labore nam eum.
					</p>
